	...
	<?php if( get_theme_mod( 'pet_animal_store_date_hide',true) != '' || get_theme_mod( 'pet_animal_store_comment_hide',true) != '' || get_theme_mod( 'pet_animal_store_author_hide',true) != '' || get_theme_mod( 'pet_animal_store_time_hide',true) != '') { ?>
		<div class="metabox py-1 mb-3">
			<?php if( get_theme_mod( 'pet_animal_store_date_hide',true) != '') { ?>
				<span class="entry-date ps-2 me-2"><i class="far fa-calendar-alt me-1"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span>
			<?php }?>
			<?php if( get_theme_mod( 'pet_animal_store_author_hide',true) != '') { ?>
				<span class="entry-author px-2 me-2"><i class="fa fa-user me-1" aria-hidden="true"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php esc_html(the_author()); ?><span class="screen-reader-text"><?php esc_html(the_author()); ?></span></a></span>
			<?php }?>
			<?php if( get_theme_mod( 'pet_animal_store_comment_hide',true) != '') { ?>
				<span class="entry-comments me-2"><i class="fa fa-comments me-1" aria-hidden="true"></i><?php comments_number( __('0 Comments','pet-animal-store'), __('0 Comments','pet-animal-store'), __('% Comments','pet-animal-store') ); ?> </span>
			<?php }?>
