	...
	<header role="banner">
		<a class="screen-reader-text skip-link" href="#main"><?php esc_html_e( 'Skip to content', 'pet-animal-store' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Skip to content', 'pet-animal-store' );?></span></a>
 		<div class="topbar py-3">
							    ...
							    <div class="col-lg-5 col-md-5 p-0 align-self-center">
							    	<div class="social-icon">
									    <?php if( get_theme_mod( 'pet_animal_store_facebook_url') != '' && get_theme_mod('pet_animal_store_facebook_icon') != 'None') { ?>
									        <a href="<?php echo esc_url( get_theme_mod( 'pet_animal_store_facebook_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('pet_animal_store_facebook_icon','fab fa-facebook-f')); ?> ms-lg-2 ms-1"></i><span class="screen-reader-text"><?php esc_html_e( 'Facebook','pet-animal-store' );?></span></a>
									    <?php } ?>
									    <?php if( get_theme_mod( 'pet_animal_store_twitter_url') != '' && get_theme_mod('pet_animal_store_twitter_icon') != 'None') { ?>
									        <a href="<?php echo esc_url( get_theme_mod( 'pet_animal_store_twitter_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('pet_animal_store_twitter_icon','fab fa-twitter')); ?> ms-lg-2 ms-1"></i><span class="screen-reader-text"><?php esc_html_e( 'Twitter','pet-animal-store' );?></span></a>
									    <?php } ?>
									    <?php if( get_theme_mod( 'pet_animal_store_instagram_url') != '' && get_theme_mod('pet_animal_store_instagram_icon') != 'None') { ?>
									        <a href="<?php echo esc_url( get_theme_mod( 'pet_animal_store_instagram_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('pet_animal_store_instagram_icon','fab fa-instagram')); ?> ms-lg-2 ms-1"></i><span class="screen-reader-text"><?php esc_html_e( 'Instagram','pet-animal-store' );?></span></a>
									    <?php } ?>
									    <?php if( get_theme_mod( 'pet_animal_store_linkedin_url') != '' && get_theme_mod('pet_animal_store_linkedin_icon') != 'None') { ?>
									        <a href="<?php echo esc_url( get_theme_mod( 'pet_animal_store_linkedin_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('pet_animal_store_linkedin_icon','fab fa-linkedin-in')); ?> ms-lg-2 ms-1"></i><span class="screen-reader-text"><?php esc_html_e( 'Linkedin','pet-animal-store' );?></span></a>
									    <?php } ?>
									    <?php if( get_theme_mod( 'pet_animal_store_youtube_url') != '' && get_theme_mod('pet_animal_store_youtube_icon') != 'None') { ?>
									        <a href="<?php echo esc_url( get_theme_mod( 'pet_animal_store_youtube_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('pet_animal_store_youtube_icon','fab fab fa-youtube')); ?> ms-lg-2 ms-1"></i><span class="screen-reader-text"><?php esc_html_e( 'Youtube','pet-animal-store' );?></span></a>
									    <?php } ?>
									</div>
							    </div>
						    </div>
			...
			<div id="header">
				<div class="container"> 
					<div class="header-slider <?php if( get_theme_mod( 'pet_animal_store_sticky_header', false) != '') { ?> sticky-header"<?php } else { ?>close-sticky <?php } ?>">
						<div class="row m-0">     
							<div class="col-lg-9 col-md-9 col-5 menubg">
								<div class="menubox nav">
									<?php if(has_nav_menu('primary')){ ?>
									    <div class="toggle-menu responsive-menu py-3">
							                <button role="tab" onclick="pet_animal_store_menu_open()"><i class="<?php echo esc_html(get_theme_mod('pet_animal_store_responsive_open_menu_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','pet-animal-store'); ?></span></button>
							            </div>
							        <?php }?>
					                <div id="menu-sidebar" class="nav side-menu">
					               		<nav id="primary-site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'pet-animal-store' ); ?>">
					                    	...
					                    	<a href="javascript:void(0)" class="closebtn responsive-menu" onclick="pet_animal_store_menu_close()"><i class="<?php echo esc_html(get_theme_mod('pet_animal_store_responsive_close_menu_icon','fas fa-times'));?>"></i></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','pet-animal-store'); ?></span></a>
					                    </nav>
					                </div>
									<div class="clear"></div>
								</div>
